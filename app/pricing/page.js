  ...
  const plans = [
    {
      ...
      stripeLinkMonthly: process.env.NEXT_PUBLIC_STRIPE_STARTER_MONTHLY || '#',
      stripeLinkAnnual: process.env.NEXT_PUBLIC_STRIPE_STARTER_ANNUAL || '#',
      popular: false
    },
    {
      name: 'Pro',
      ...
      stripeLinkMonthly: process.env.NEXT_PUBLIC_STRIPE_PRO_MONTHLY || '#',
      stripeLinkAnnual: process.env.NEXT_PUBLIC_STRIPE_PRO_ANNUAL || '#',
      popular: true
    },
    {
      name: 'Business',
      ...
      stripeLinkMonthly: process.env.NEXT_PUBLIC_STRIPE_BUSINESS_MONTHLY || '#',
      stripeLinkAnnual: process.env.NEXT_PUBLIC_STRIPE_BUSINESS_ANNUAL || '#',
      popular: false
    }
  ]
